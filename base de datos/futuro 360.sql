...
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (1, 'Ingeniería en Sistemas de Información', 'Diseño y desarrollo de software, bases de datos, redes y sistemas informáticos.', 'Tecnología', 'UTN - FR Tucumán, UNT - FACET', 1, '', 'imagenes/tecnologia-Ingeniería en Sistemas de Información-portada.jpg', 'imagenes/tecnologia-Ingeniería en Sistemas de Información-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (2, 'Licenciatura en Sistemas de Información', 'Análisis, diseño e implementación de sistemas de información empresariales.', 'Tecnología', 'UNT - FACET, UNSTA', 0, '', 'imagenes/tecnologia-Licenciatura en Sistemas de Información-portada.jpg', 'imagenes/tecnologia-Licenciatura en Sistemas de Información-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (3, 'Tecnicatura en Programación', 'Desarrollo de aplicaciones web, móviles y de escritorio. Salida laboral rápida.', 'Tecnología', 'UTN - FR Tucumán, Institutos Superiores de Tucumán', 0, '', 'imagenes/tecnologia-Tecnicatura en Programación-portada.jpg', 'imagenes/tecnologia-Tecnicatura en Programación-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (4, 'Ingeniería Civil', 'Diseño y construcción de infraestructuras: edificios, puentes, caminos y obras hidráulicas.', 'Ingeniería', 'UNT - FACET, UTN - FR Tucumán', 1, '', 'imagenes/ingenieria-ingenieria civil-portada.jpg', 'imagenes/ingenieria-ingenieria civil-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (5, 'Ingeniería Mecánica', 'Diseño, análisis y mantenimiento de sistemas mecánicos y procesos industriales.', 'Ingeniería', 'UNT - FACET, UTN - FR Tucumán', 0, '', 'imagenes/ingenieria-ingenieria mecanica-portada.jpg', 'imagenes/ingenieria-ingenieria mecanica-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (6, 'Ingeniería Eléctrica', 'Generación, transmisión y distribución de energía eléctrica. Automatización industrial.', 'Ingeniería', 'UNT - FACET, UTN - FR Tucumán', 0, '', 'imagenes/ingenieria-ingenieria electrica-portada.jpg', 'imagenes/ingenieria-ingenieria electrica-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (7, 'Ingeniería Industrial', 'Optimización de procesos productivos, gestión de calidad y logística industrial.', 'Ingeniería', 'UTN - FR Tucumán, UNT - FACET', 0, '', 'imagenes/ingenieria-ingenieria industrial-portada.jpg', 'imagenes/ingenieria-ingenieria industrial-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (8, 'Ingeniería Química', 'Transformación de materias primas en productos industriales mediante procesos químicos.', 'Ingeniería', 'UNT - FACET', 0, '', 'imagenes/ingenieria-ingenieria quimica-portada.jpg', 'imagenes/ingenieria-ingenieria quimica-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (9, 'Medicina', 'Diagnóstico, tratamiento y prevención de enfermedades.', 'Salud', 'UNT - Facultad de Medicina', 1, '', 'imagenes/salud-medicina-portada.jpg', 'imagenes/salud-medicina-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (10, 'Enfermería', 'Cuidado integral del paciente en hospitales, clínicas y atención domiciliaria.', 'Salud', 'UNT - Facultad de Medicina, Instituto Superior de Enfermería', 0, '', 'imagenes/salud-enfermeria-portada.jpg', 'imagenes/salud-enfermeria-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (11, 'Odontología', 'Diagnóstico y tratamiento de enfermedades bucodentales.', 'Salud', 'UNT - Facultad de Odontología', 0, '', 'imagenes/salud-odontologia-portada.jpg', 'imagenes/salud-odontologia-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (12, 'Kinesiología y Fisioterapia', 'Rehabilitación física y recuperación del movimiento.', 'Salud', 'UNT - Facultad de Medicina', 0, '', 'imagenes/salud-Kinesiología y Fisioterapia-portada.jpg', 'imagenes/salud-Kinesiología y Fisioterapia-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (13, 'Nutrición', 'Planificación de dietas y planes alimentarios para individuos y comunidades.', 'Salud', 'UNT - Facultad de Medicina, UNSTA', 0, '', 'imagenes/salud-nutrición-portada.jpg', 'imagenes/salud-nutrición-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (14, 'Bioquímica', 'Análisis clínicos, investigación farmacéutica y control de calidad alimentaria.', 'Salud', 'UNT - FBQyF', 0, '', 'imagenes/salud-bioquimica-portada.jpg', 'imagenes/salud-bioquimica-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (15, 'Farmacia', 'Dispensación de medicamentos, control de calidad y farmacología clínica.', 'Salud', 'UNT - FBQyF', 0, '', 'imagenes/salud-farmacia-portada.jpg', 'imagenes/salud-farmacia-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (16, 'Psicología', 'Estudio del comportamiento humano, terapia individual y grupal.', 'Salud Mental', 'UNT - Facultad de Psicología, UNSTA', 1, '', 'imagenes/salud mental-Psicología-portada.jpg', 'imagenes/salud mental-Psicología-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (17, 'Trabajo Social', 'Intervención en problemáticas sociales y acompañamiento a comunidades vulnerables.', 'Salud Mental', 'UNT - Facultad de Filosofía y Letras', 0, '', 'imagenes/salud mental-trabajo social-portada.jpg', 'imagenes/salud mental-trabajo social-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (18, 'Psicopedagogía', 'Diagnóstico y tratamiento de dificultades de aprendizaje.', 'Salud Mental', 'UNSTA, Institutos Superiores de Tucumán', 0, '', 'imagenes/salud mental-psicopedagogia-portada.jpg', 'imagenes/salud mental-psicopedagogia-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (19, 'Biología', 'Estudio de los seres vivos, genética, ecología y biotecnología.', 'Ciencias Naturales', 'UNT - Facultad de Ciencias Naturales', 0, '', 'imagenes/ciencias naturales-biologia-portada.jpg', 'imagenes/ciencias naturales-biologia-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (20, 'Geología', 'Estudio de la estructura y composición de la Tierra. Minería y recursos naturales.', 'Ciencias Naturales', 'UNT - Facultad de Ciencias Naturales', 0, '', 'imagenes/ciencias naturales-geologia-portada.jpg', 'imagenes/ciencias naturales-geologia-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (21, 'Química', 'Investigación y aplicación de la composición y transformación de la materia.', 'Ciencias Naturales', 'UNT - FBQyF', 0, '', 'imagenes/ciencias naturales-quimica-portada.jpg', 'imagenes/ciencias naturales-quimica-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (22, 'Ingeniería Agronómica', 'Producción vegetal, manejo de suelos y gestión de empresas agropecuarias.', 'Agronomía', 'UNT - FAZ', 0, '', 'imagenes/agronomia-ingenieria agronomica -portada.jpg', 'imagenes/agronomia-ingenieria agronomica -principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (23, 'Medicina Veterinaria', 'Salud y producción animal, sanidad de mascotas y animales de granja.', 'Agronomía', 'UNT - FAZ', 0, '', 'imagenes/agronomia-medicina veterinaria-portada.jpg', 'imagenes/agronomia-medicina veterinaria-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (24, 'Ingeniería Forestal', 'Manejo y conservación de bosques, recursos madereros y gestión ambiental.', 'Agronomía', 'UNT - FAZ', 0, '', 'imagenes/agronomia-ingenieria forestal -portada.jpg', 'imagenes/agronomia-ingenieria forestal -principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (25, 'Tecnicatura en Producción Agropecuaria', 'Formación técnica en producción animal y vegetal con salida laboral rápida.', 'Agronomía', 'INTA Tucumán, Institutos Superiores Rurales', 0, '', 'imagenes/agronomia-Tecnicatura en Producción Agropecuaria-portada.jpg', 'imagenes/agronomia-Tecnicatura en Producción Agropecuaria-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (26, 'Contador Público Nacional', 'Auditoría, impuestos, contabilidad y asesoramiento financiero empresarial.', 'Negocios', 'UNT - FCE, UNSTA', 1, '', 'imagenes/negocios-contador publico nacional-portada.jpg', 'imagenes/negocios-contador publico nacional-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (27, 'Licenciatura en Administración', 'Gestión de empresas, recursos humanos, marketing y estrategia organizacional.', 'Negocios', 'UNT - FCE, UNSTA, UTN', 1, '', 'imagenes/negocios-licenciatura en administracion-portada.jpg', 'imagenes/negocios-licenciatura en administracion-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (28, 'Licenciatura en Economía', 'Análisis de mercados, política económica y desarrollo regional.', 'Negocios', 'UNT - FCE', 0, '', 'imagenes/negocios-licenciatura en economia-portada.jpg', 'imagenes/negocios-licenciatura en economia-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (29, 'Marketing Digital', 'Estrategias de comunicación digital, publicidad online y posicionamiento de marcas.', 'Negocios', 'UNSTA, Institutos Superiores de Tucumán', 0, '', 'imagenes/negocios-marketing digital-portada.jpg', 'imagenes/negocios-marketing digital-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (30, 'Abogacía', 'Representación legal, litigios y asesoramiento jurídico en todas las ramas del derecho.', 'Derecho', 'UNT - Facultad de Derecho, UNSTA', 1, '', 'imagenes/derecho-abogacia-portada.jpg', 'imagenes/derecho-abogacia-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (31, 'Notariado', 'Escrituras, contratos y documentos legales con fe pública.', 'Derecho', 'UNT - Facultad de Derecho', 0, '', 'imagenes/derecho-notariado-portada.jpg', 'imagenes/derecho-notariado-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (32, 'Ciencias Políticas', 'Análisis del poder, instituciones del Estado y gestión pública.', 'Derecho', 'UNT - Facultad de Derecho', 0, '', 'imagenes/derecho-ciencias politicas-portada.jpg', 'imagenes/derecho-ciencias politicas-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (33, 'Licenciatura en Historia', 'Investigación y enseñanza del pasado humano. Archivos, museos y docencia.', 'Humanidades', 'UNT - Facultad de Filosofía y Letras', 0, '', 'imagenes/humanidades-licenciatura en historia-portada.png', 'imagenes/humanidades-licenciatura en historia-principal.png', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (34, 'Licenciatura en Filosofía', 'Pensamiento crítico, ética, lógica y epistemología.', 'Humanidades', 'UNT - Facultad de Filosofía y Letras', 0, '', 'imagenes/humanidades-licenciatura en filosofia-portada.jpg', 'imagenes/humanidades-licenciatura en filosofia-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (35, 'Licenciatura en Letras', 'Literatura, lingüística, escritura creativa y docencia de lengua.', 'Humanidades', 'UNT - Facultad de Filosofía y Letras', 0, '', 'imagenes/humanidades-licenciatura en letras-portada.png', 'imagenes/humanidades-licenciatura en letras-principal.png', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (36, 'Diseño Gráfico', 'Creación visual de marcas, publicidad, packaging e interfaces digitales.', 'Arte y Diseño', 'UNT - Facultad de Artes, UNSTA, Institutos Superiores', 1, '', 'imagenes/arte y diseño-diseño grafico-portada.jpg', 'imagenes/arte y diseño-diseño grafico-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (37, 'Licenciatura en Artes Visuales', 'Pintura, escultura, instalación y gestión cultural.', 'Arte y Diseño', 'UNT - Facultad de Artes', 0, '', 'imagenes/arte y diseño-Licenciatura en Artes Visuales-portada.jpg', 'imagenes/arte y diseño-Licenciatura en Artes Visuales-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (38, 'Música', 'Interpretación, composición y dirección musical.', 'Arte y Diseño', 'UNT - Facultad de Artes', 0, '', 'imagenes/arte y diseño-musica-portada.jpg', 'imagenes/arte y diseño-musica-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (39, 'Arquitectura', 'Diseño y planificación de edificios y espacios. Combina arte, técnica y funcionalidad.', 'Arte y Diseño', 'UNT - FAU', 0, '', 'imagenes/arte y diseño-arquitectura-portada.jpg', 'imagenes/arte y diseño-arquitectura-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (40, 'Licenciatura en Comunicación Social', 'Periodismo, relaciones públicas, comunicación institucional y medios digitales.', 'Comunicación', 'UNT - Facultad de Filosofía y Letras', 0, '', 'imagenes/comunicación-Licenciatura en Comunicación Social-portada.jpg', 'imagenes/comunicación-Licenciatura en Comunicación Social-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (41, 'Periodismo', 'Reportaje, redacción, conducción y producción periodística en todos los medios.', 'Comunicación', 'Institutos Superiores de Tucumán, UNT', 0, '', 'imagenes/comunicación-periodismo-portada.jpg', 'imagenes/comunicación-periodismo-principal.jpg', NULL);
INSERT INTO `carreras` (`id`, `nombre`, `descripcion`, `area_profesional`, `instituciones`, `popular`, `imagen`, `imagen_portada`, `imagen_principal`, `a_que_se_dedica`) VALUES (42, 'Publicidad', 'Creación de campañas publicitarias, estrategia de marca y comunicación persuasiva.', 'Comunicación', 'UNSTA, Institutos Superiores', 0, '', 'imagenes/comunicación-publicidad-portada.jpg', 'imagenes/comunicación-publicidad-principal.jpg', NULL);
